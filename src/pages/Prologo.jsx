...
export default function Prologo() {
  ...
  const opcoes = [
    {
      texto: "Olha na Mesa",
      inventario: [{ nome: "Imagens", textoTooltip: "atras da carta esta escrito: Eles estão chegando,ele esta chegando,7 viram 7 iram,a lua camersim esta surgindo e o sacrifico sera feito", url:"src/pages/imgs/fotografia.png"}],
